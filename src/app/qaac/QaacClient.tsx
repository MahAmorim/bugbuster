            ...
            {[
              ...
              <div key={b.title} className="h-full">
                <div className="relative border border-border bg-white dark:bg-[#111] rounded-xl shadow-md hover:-translate-y-1 hover:shadow-lg hover:brightness-105 transition-transform h-full">
                  <div className={`absolute -z-0 top-0 left-0 right-0 h-1.5 bg-gradient-to-r ${b.color}`} />
                  <div className="p-5">
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className={`absolute -z-0 top-0 left-0 right-0 h-1.5 bg-gradient-to-r ${item.color}`} />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              ...
              >
                <div className="absolute -z-0 top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-purple-400 via-blue-500 to-cyan-400" />
